...
void twistCallback(const geometry_msgs::Twist::ConstPtr& msg)
{
	...
	vels.fr = (velForw - velRight + (modelLength + modelWidth) * rotLeft * 0.5) / wheelRadius;
	vels.fl = (velForw + velRight - (modelLength + modelWidth) * rotLeft * 0.5) / wheelRadius;
	vels.rl = (velForw - velRight - (modelLength + modelWidth) * rotLeft * 0.5) / wheelRadius;
	vels.rr = (velForw + velRight + (modelLength + modelWidth) * rotLeft * 0.5) / wheelRadius;
