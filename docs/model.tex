...
\section{Generator sterowania}
	...
	Po zakończeniu wykonywania instrukcji, pakiet generuje wiadomość o zerowych parametrach w celu zatrzymania bazy.
...
\section{Obserwator symulacji}
	...
	Pozwala zbadać, jak model dynamiki zachowuje się w stosunku do modelu kinematycznego, to znaczy, 
