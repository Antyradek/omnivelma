...
Nie jest to żaden system operacyjny, a obszerna platforma programistyczna (framework) zawierająca odpowiednie biblioteki i narzędzia do tworzenia programów sterujących.
...
Z drugiej jednak strony wirtualizacja systemu operacyjnego z ROS bardzo ogranicza dostępną moc obliczeniową potrzebną w dużych ilościach takim programom.

\subsection{Narzędzia}
Do tworzenia oprogramowania na systemach Unixowych można użyć dowolnych edytorów, gdyż standardowo wszystko jest potem kompilowane za pomocą narzędzi wiersza poleceń i skrypty.
Do tworzen
% Gazebo i ROS
% Atom do uniwersalnej edycji
% Cmake do oskryptowania
% GCC do kompilacji
% C::B, lub Eclipse do kodu kompilowanego
% Bash do automatyzacji uruchamiania
% GIT do kontroli wersji
% Virtualbox do ROS, lub przyszła instalacja, lub dysk flash
