...
%TODO dokładny model koła szwedzkiego, może render?
...
\subsection{Gazebo}
Ten symulator graficzny jest dość prosty w obsłudze, skupia się na symulowaniu podanych danych, a mniej na możliwości ich łatwego przygotowania.
...
\subsection{V-Rep}
Duże i skomplikowane środowisko reklamujące się wieloma zaawansowanymi mechanizmami i funkcjami.
...
%TODO Dopisać maszyny z dokumentacji
\subsection{Inne środowiska}
