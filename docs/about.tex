...
\section{Czujnik laserowy}
	...
	\subsection{Podstawowe cechy}
		...
		\label{tab:lidar}
		\end{table}
		Na podstawie tych danych można obliczyć, że w jednym przebiegu po całym zakresie kątowym urządzenia, emitowane jest około 1080, lub 540 impulsów.
		Taka ilość wymagana jest w symulacji, aby wiernie odwzorować działanie urządzenia.
