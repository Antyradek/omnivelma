...
Platforma wyposażona jest w dwa, dwuwymiarowe czujniki laserowe typu LiDAR firmy SICK.
...
Na koniec zaawansowany algorytm we wbudowanym mikrokontrolerze ustala kąt i odległość wykrytego obiektu na podstawie tych danych.
Odpowiada także za usunięcie szumu i ewentualnych odbić promienia.
Komunikacja odbywa się za pomocą różnych interfejsów sieciowych.
...
Program komunikujący się bezpośrednio z urządzeniem zwraca listę kolejnych, wykrytych punktów.
