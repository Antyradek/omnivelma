...
\begin{document}
	...
	\end{frame}
	\begin{frame}
		\frametitle{Na co pozwalają}
		\begin{block}{Wynalezione w 1973}
			Przez szwedzkiego inżyniera Beng Ilona zatrudnionego w firmie Mecanum.\footnotemark
		\end{block}
		\begin{itemize}
			\item Rolka obrócona względem osi o 45\textdegree.
			\item Każde koło ma 12 pasywnych rolek.
			\item Koła posiadają po 3 stopnie swobody.
